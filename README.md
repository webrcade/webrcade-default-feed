...
The [default feed AUTHORS page](https://github.com/webrcade/webrcade/blob/master/AUTHORS-default-feed.md) includes the list of titles that are included in the default feed, their respective authors, and related links. 
